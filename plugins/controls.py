...
async def player(client, message):
    if not Config.CALL_STATUS:
        await message.reply_text(
            "Oyuncu boşta, oynatıcıyı aşağıdaki düğmeyi kullanarak başlatın. ㅤㅤㅤㅤ",
...
async def pause_playing(_, m: Message):
    if not Config.CALL_STATUS:
        await m.reply_text(
            "Oyuncu boşta, oynatıcıyı aşağıdaki düğmeyi kullanarak başlatın. ㅤㅤㅤㅤㅤ",
            disable_web_page_preview=True,
            reply_markup=await get_buttons()
        )
        await delete_messages([m])
...
async def set_vol(_, m: Message):
    ...
    if not 1 < int(m.command[1]) < 200:
        ...
        await m.reply_text(f"Ses düzeyini başarıyla {m.command[1]} olarak ayarlayın ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ", reply_markup=await volume_buttons())
    await delete_messages([m])
...
async def set_mute(_, m: Message):
    if not Config.CALL_STATUS:
        await m.reply_text(
            "Oyuncu boşta, oynatıcıyı aşağıdaki düğmeyi kullanarak başlatın. ㅤㅤㅤㅤㅤㅤㅤㅤ",
            disable_web_page_preview=True,
            reply_markup=await get_buttons()
        )
        await delete_messages([m])
...
async def replay_playout(client, m: Message):
    msg = await m.reply('Oyuncu kontrol ediliyor')
    if not Config.CALL_STATUS:
        await msg.edit(
            "Oyuncu boşta, oynatıcıyı aşağıdaki düğmeyi kullanarak başlatın. ㅤㅤㅤㅤㅤ",
            disable_web_page_preview=True,
...
async def show_player(client, m: Message):
    ...
    if not data.get('dur', 0) or \
        data.get('dur') == 0:
        title="<b>Canlı Akış Oynatılıyor</b> ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ"
    else:
        if Config.playlist:
            title=f"<b>{Config.playlist[0][1]}</b> ㅤㅤㅤㅤ\n ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ"
        elif Config.STREAM_LINK:
            title=f"<b>[Url]({data['file']}) Kullanarak Akış </b> ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ"
        else:
            title=f"<b>Akış Başlangıcı [akış]({Config.STREAM_URL})</b> ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ"
    if m.chat.type == "private":
        await m.reply_text(
            title,
            disable_web_page_preview=True,
...
async def seek_playout(client, m: Message):
    if not Config.CALL_STATUS:
        await m.reply_text(
            "Oyuncu boşta, oynatıcıyı aşağıdaki düğmeyi kullanarak başlatın. ㅤㅤㅤ ㅤㅤ",
            disable_web_page_preview=True,
            reply_markup=await get_buttons()
        )
        await delete_messages([m])
    ...
    if ' ' in m.text:
        ...
        if not data.get('dur', 0)\
            ...
            if Config.playlist:
                ...
                title=f"<b>[Url]({data['file']}) Kullanarak Akış Yap</b> ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ"
            else:
                title=f"<b>Akış Başlangıcı [akış]({Config.STREAM_URL})</b> ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ"
        if Config.msg.get('player'):
            await Config.msg['player'].delete()  
        ...
        await k.edit('Zaman belirtilmedi')
        await delete_messages([m, k])
